...
var workbook = XLSX.readFile('mock_files/input/etl_output.xlsx')
    ...
    courseSectionCreationEvents.push(
      {
        ...
        'obj': {
          ...
          'val': {
            ...
            'last_date_to_withdraw': row.last_date_to_withdraw || '',
    ...
    studentEnrollmentEvent.push(
      {
        ...
        'obj': {
          ...
          'val': {
            ...
            'enrollment_status_change_date': row.enrollment_status_change_date || '',
